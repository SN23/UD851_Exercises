...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // TODCompleteO (4) Set the padding to 16dp
    ...
    // Complete (8) Align the TextView to the start of the parent
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView listItemNumberTextView;


        public NumberViewHolder(View itemView) {
            super(itemView);

            listItemNumberTextView = (TextView) itemView.findViewById(R.id.tv_item_number);
        }

        void bind(int lastIndex) {
            listItemNumberTextView.setText(Integer.toString(lastIndex));
        }
    }
